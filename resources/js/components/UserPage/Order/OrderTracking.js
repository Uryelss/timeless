...
import { Layout, Button, message, Typography, Image, Modal, Radio, Space, Card } from "antd";
import {
    LeftOutlined,
    FileTextOutlined,
    DollarOutlined,
    ...
    const fetchUsername = async () => {
        ...
        try {
            ...
            if (error.response?.status === 401) {
                ...
                message.error("Server error fetching username. Please try again later.");
            }
            setUsername("N/A");
        }
    };
                        ...
                        <div className="main-content">
                            ...
                            <Card className="shipping-card">
                                ...
                                <div className="shipping-info">
                                    ...
                                    <Text block>
                                        Phone:{" "}
                                        {order.shipping?.address?.phone || "Not Available"}
                                    </Text>
                                    <Text block>
                                        Tracking Number:{" "}
