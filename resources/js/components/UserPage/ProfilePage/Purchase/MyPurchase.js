    ...
    <div>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <Tabs defaultActiveKey="1" type="card">
          ...
          <TabPane tab={<span>To Receive <Badge count={filterOrdersByStatus('To Receive').length} style={{ backgroundColor: '#f5222d' }} /></span>} key="4">
        ...
        <Row align="middle">
          ...
          <Col span={12} style={{ textAlign: 'right' }}>
            <span style={{ color: '#13c2c2' }}>
              {order.status === 'To Receive' ? 'Parcel has arrived and to be received by the delivery hub' : order.status}
            </span>{' '}
            <Button type="link" style={{ color: '#f5222d' }}>{order.status.toUpperCase()}</Button>
          </Col>
        </Row>
        <hr />
        ...
        <Row align="middle">
          ...
          <Col span={12} style={{ textAlign: 'right' }}>
            <Space>
              ...
              <Button type="primary" danger>Contact Seller</Button>
            </Space>
          </Col>
        </Row>
      </Card>
